// Load Texty libraries
var Texty = require('./texty/texty.js'),
    TCPConnection = require('./texty/lib/connections/tcp.js'),
    RedisStore = require('./texty/lib/auth/redis.js');

// Load the game module
var world = JSON.parse(require('fs').readFileSync(__dirname + '/stroll/world.json'));

// Initialize the Texty module with the game
var game = new Texty({
    world: world,
    modules: {
        gameMessaging: require('./texty/lib/gameMessaging.js')
    }
});
